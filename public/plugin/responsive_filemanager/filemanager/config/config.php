...
//tambahin session
session_start();
$isBaseUrl = (!empty($_SERVER['HTTPS']) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'] . '/project/claveo/backend/web';

if(!isset($_SESSION['fm'])){
    echo "Status: 401, please logout and login again";
    // header("location:$isBaseUrl");
    die();
}
$version = "9.14.0";
if (session_id() == '') {
