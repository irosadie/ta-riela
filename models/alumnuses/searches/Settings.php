...
use app\models\alumnuses\generals\Settings as SettingsModel;

/**
 * Settings represents the model behind the search form of `app\models\alumnuses\generals\Settings`.
 */
