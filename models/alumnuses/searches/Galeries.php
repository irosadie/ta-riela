...
use app\models\alumnuses\generals\Galeries as GaleriesModel;

/**
 * Galeries represents the model behind the search form of `app\models\alumnuses\generals\Galeries`.
 */
class Galeries extends GaleriesModel
{
    public $query;
